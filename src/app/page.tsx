              ...
              <div className='overflow-y-auto flex-1'>
                  <div className='relative w-full h-full overflow-hidden'>
                      <div className='relative left-32 top-10'>
                          <Typography variant='h1' weight='black' transform='uppercase' className={`${homeStyles.hero1} opacity-0 text-transparent bg-clip-text bg-gradient-to-r from-red to-blue absolute top-14 left-6`}>high elo boost</Typography>
                          <Typography variant='h3' weight='regular' transform='capitalize' className={`${homeStyles.hero1} opacity-0 absolute top-32 left-6`}>Fast, Cheap, Reliable</Typography>
                          <Typography variant='h1' weight='black' transform='uppercase' className={`${homeStyles.hero2} opacity-0 text-transparent bg-clip-text bg-gradient-to-r from-red to-blue absolute top-14 left-6`}>Coaching</Typography>
                      ...
                      <div className='absolute right-56 bottom-10'>
