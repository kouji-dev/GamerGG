            ...
            <div className='flex gap-md'>
                ...
                <div className='flex flex-col gap-sm'>
                    <div className='flex gap-sm items-center'>
                        <Typography variant='h6' weight='bold'>lol - AEC1232213</Typography>
                        <Copy/>
                    ...
                    <div className='flex gap-sm'>
                        <div className='flex gap-xs items-center'>
                            <Place/>
                            <Typography variant='subtitle' weight='bold'>Rank Boost</Typography>
                        </div>
                        <div className='flex gap-xs items-center'>
                            <Place/>
                            <Typography variant='subtitle' weight='bold'>EU-West</Typography>
                        </div>
                        <div className='flex gap-xs items-center'>
                            <Place/>
                            <Typography variant='subtitle' weight='bold'>49.23$</Typography>
                        </div>
                        <div className='flex gap-xs items-center'>
                            <Place/>
                            <Typography variant='subtitle' weight='bold'>SUPER22 - 16%</Typography>
                        </div>
                    </div>
                    <div className='flex gap-lg items-center'>
                        <div className='border-2 border-filter-100 border-dashed p-sm flex gap-sm rounded'>
                            ...
                            <div className='flex flex-col gap-sm'>
                                <Typography variant='subtitle' weight='bold'>Platinum III</Typography>
                                <Typography variant='subtitle' weight='bold'>0 LP</Typography>
                            </div>
                        </div>
                        <ArrowRight/>
                        <div className='border-2 border-filter-100 border-dashed p-sm flex gap-sm rounded'>
